                ...
                <aside id="leftsidebar" className="sidebar">
                        ...
                        <div className="info-container">
                            ...
                            <div className={this.state.defaultClass}>
                                ...
                                <ul className="dropdown-menu pull-right">
                                    ...
                                    <li><a href="javascript:void(0);" className=" waves-effect waves-block"><i
                    ...
                    <div className="menu">
                        <div className="slimScrollDiv"
                             style={{position: "relative", overflow: "hidden", width: "auto", height: "57px"}}>
                            <ul className="list" style={{overflow:" hidden", width: "auto",height: "57px"}}>
                            ...
                            <div className="slimScrollBar"
                                 style={{background: "rgba(0, 0, 0, 0.5)", width: "4px", position: "absolute", top:" 0px", opacity: "0.4", display: "block", borderRadius: "0px", zIndex: "99", right:" 1px", height: "126.64px"}}></div>
                            <div className="slimScrollRail"
                                 style={{width: "4px", height: "100%", position: "absolute", top: "0px", display: "none", borderRadius: "0px", background: "rgb(51, 51, 51)", opacity: "0.2", zIndex: "90", right: "1px"}}></div>
                        </div>
                    </div>
