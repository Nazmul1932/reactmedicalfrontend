...
//                                                 <td><button className="btn btn-block btn-warning" onClick={()=>this.showEmployeeDetails(employee.id)}>View</button></td>
//                                             </tr>
//                                         )}
//                                         </tbody>
//                                     </table>
                                ...
                                <div className="body">
                                    <form onSubmit={this.formSubmitSalary}>
                                        ...
                                        <button
                                            type="submit"
                                            className="btn btn-primary m-t-15 waves-effect btn-block"
                                            disabled={this.state.btnMessageSalary !== 0}
                                        >
                                ...
                                <div className="body">
                                    <form onSubmit={this.formSubmitBank}>
                                        ...
                                        <button
                                            type="submit"
                                            className="btn btn-primary m-t-15 waves-effect btn-block"
                                            disabled={this.state.btnMessageBank !== 0}
                                        >
